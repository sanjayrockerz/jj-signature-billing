...
const CUSTOMER_LOGIN_ID = String(import.meta.env.VITE_CUSTOMER_ID || 'jjsignature').trim().toLowerCase()
const CUSTOMER_AUTH_EMAIL = String(import.meta.env.VITE_CUSTOMER_AUTH_EMAIL || 'safasignora@gmail.com').trim().toLowerCase()
...
export const authService = {
  ...
  signIn: async (email: string, password: string): Promise<{ user: AuthUser | null; error: string | null }> => {
    ...
    const loginEmail = normalizedLogin === CUSTOMER_LOGIN_ID ? CUSTOMER_AUTH_EMAIL : normalizedLogin
