          ...
          <div className="h-52 sm:h-56">
            <ResponsiveContainer width="100%" height="100%" minWidth={0} minHeight={0}>
              <LineChart data={analytics.monthlyTrend}>
                ...
                <Line type="monotone" dataKey="revenue" stroke="#8C7358" strokeWidth={2.5} dot={false} activeDot={{ r: 4 }} />
              </LineChart>
            </ResponsiveContainer>
          </div>
        </div>
            ...
            <div className="h-48 sm:h-52">
              <ResponsiveContainer width="100%" height="100%" minWidth={0} minHeight={0}>
                <BarChart data={analytics.topCategories} layout="vertical" margin={{ left: 8, right: 8 }}>
                  ...
                  <Bar dataKey="qty" fill="#CBB89D" radius={[0, 8, 8, 0]} barSize={14} />
                </BarChart>
              </ResponsiveContainer>
            </div>
          </div>
            ...
            <div className="h-48 sm:h-52">
              <ResponsiveContainer width="100%" height="100%" minWidth={0} minHeight={0}>
                <BarChart data={analytics.weeklySales}>
                  ...
                  <Bar dataKey="revenue" fill="#8C7358" radius={[8, 8, 0, 0]} barSize={16} />
                </BarChart>
              </ResponsiveContainer>
            </div>
          </div>
