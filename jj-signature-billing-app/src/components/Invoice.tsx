  ...
  return (
    ...
    >
      ...
      <div style={{ textAlign: 'center', borderBottom: '1px solid #e5e7eb', paddingBottom: 20, marginBottom: 20 }}>
        ...
        <div style={{ fontSize: 22, fontWeight: 900, color: '#111111', letterSpacing: -0.5, textTransform: 'uppercase' }}>
          {BRAND_EN}
        </div>
        <div style={{ fontSize: 11, color: '#51483e', marginTop: 4, fontWeight: 500, paddingLeft: 8, paddingRight: 8, maxWidth: 440, marginLeft: 'auto', marginRight: 'auto' }}>
          {BRAND_ADDRESS}
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
        ...
        <div style={{ minWidth: 0, padding: '12px 14px', borderRadius: 10, background: '#F3EBDD', overflowWrap: 'anywhere' }}>
          ...
          <div style={{ fontSize: 12, color: '#555', lineHeight: 1.4, wordBreak: 'break-word' }}>{phone ? formatIndianPhone(phone) : '—'}</div>
      ...
      <div className="w-full overflow-x-auto">
        <table style={{ width: '100%', borderCollapse: 'collapse', minWidth: 0, tableLayout: 'fixed' }}>
          <thead>
            <tr style={{ background: '#F3EBDD', borderRadius: 8 }}>
              <th style={{ padding: '8px 10px', textAlign: 'left', fontSize: 10, fontWeight: 800, color: '#111111', textTransform: 'uppercase', letterSpacing: 0.8, width: 28 }}>#</th>
              <th style={{ padding: '8px 10px', textAlign: 'left', fontSize: 10, fontWeight: 800, color: '#111111', textTransform: 'uppercase', letterSpacing: 0.8, width: 'auto' }}>Product</th>
              <th style={{ padding: '8px 10px', textAlign: 'center', fontSize: 10, fontWeight: 800, color: '#111111', textTransform: 'uppercase', letterSpacing: 0.8, width: 45 }}>Qty</th>
              <th style={{ padding: '8px 10px', textAlign: 'right', fontSize: 10, fontWeight: 800, color: '#111111', textTransform: 'uppercase', letterSpacing: 0.8, width: 75 }}>Rate</th>
              <th style={{ padding: '8px 10px', textAlign: 'right', fontSize: 10, fontWeight: 800, color: '#111111', textTransform: 'uppercase', letterSpacing: 0.8, width: 85 }}>Amount</th>
            </tr>
          </thead>
          <tbody>
            {items.map((item, idx) => {
      ...
      {/* ── TOTALS ───────────────────────────────────────────────── */}
      <div style={{ marginTop: 24, borderTop: '2px solid #111111', paddingTop: 16 }}>
          ...
          <div style={{ minWidth: 240, width: '100%', maxWidth: 300 }}>
            ...
            <div
              style={{
                ...
                borderTop: '2px solid #111111', paddingTop: 10, marginTop: 4,
              }}
            >
              <span style={{ fontSize: 15, fontWeight: 900, color: '#111111', textTransform: 'uppercase', letterSpacing: 0.5 }}>Total</span>
              <span style={{ fontSize: 20, fontWeight: 900, color: '#111111' }}>{formatCurrency(total)}</span>
            </div>
          </div>
        </div>
      </div>
      ...
      >
        <div style={{ fontSize: 12, fontWeight: 800, color: '#111111' }}>Thank you for shopping with J.J Signature!</div>
        {onPrintReceipt && (
          <button
            type="button"
            ...
            style={{
              ...
              background: '#CBB89D', color: '#171717', fontSize: 12, fontWeight: 700, cursor: 'pointer',
            }}
          >
            Print Receipt
          </button>
