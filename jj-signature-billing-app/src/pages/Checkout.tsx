...
export default function Checkout() {
  ...
  const handleCheckout = async () => {
    ...
    if (!isValidPhone(form.phone)) {
      setError('Please enter a valid Indian WhatsApp number (e.g. 6379048966 or +91 6379048966)')
      return
    }
              ...
              <div>
                ...
                <div className="flex gap-2">
                  ...
                  <input
                    ...
                    placeholder="6379048966 or +91 6379048966"
                ...
                {form.phone && !isValidPhone(form.phone) && (
                  <p className="mt-1 text-xs text-red-500 font-medium">Invalid number — enter a valid 10-digit Indian number or +91 number</p>
                )}
                {form.phone && isValidPhone(form.phone) && (
